...
namespace LayaliAlfajar.Areas.Customer.Controllers

{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
			...
			//			if (applicationUser.CompanyId.GetValueOrDefault() == 0)
			//			{
			//				//it is a regular customer account and need to capture a payment
			//				//stripe logic
			...
			//						{
			//							UnitAmount = (long)(item.Price * 100), //for example if 20.50 => 2050
			//							Currency = "aed",
			//							ProductData = new SessionLineItemPriceDataProductDataOptions
			//							{
			//								Name = item.Product.Style
			//							}
			//						},
			//						Quantity = item.Count
			//					};
			...
			//			{
			//				//then this is an order by customer
			//				var service = new SessionService();
			...
			//		ShoppingCartVM.OrderHeader.City = ShoppingCartVM.OrderHeader.ApplicationUser.City;
			//		ShoppingCartVM.OrderHeader.State = ShoppingCartVM.OrderHeader.ApplicationUser.State;
			//		ShoppingCartVM.OrderHeader.Country = ShoppingCartVM.OrderHeader.Country;
			//		ShoppingCartVM.OrderHeader.PostCode = ShoppingCartVM.OrderHeader.ApplicationUser.Postcode;
		...
		public IActionResult OrderConfirmation(int id)
		{
			...
			_emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order - LayaliAlFajar",
